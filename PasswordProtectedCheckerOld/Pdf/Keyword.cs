...
namespace PasswordProtectedChecker.Pdf
{
    ...
    */
    public static class Keyword
    {
      ...
      */
        public static readonly string BeginDictionary = Symbol.OpenAngleBracket + Symbol.OpenAngleBracket.ToString();
      ...
      */
        public static readonly string EndDictionary = Symbol.CloseAngleBracket + Symbol.CloseAngleBracket.ToString();
