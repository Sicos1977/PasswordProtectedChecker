    ...
    public abstract class PdfObject : IVisitable
    {
      ...
      */
        public PdfIndirectObject DataContainer
        {
            get
            {
                var indirectObject = IndirectObject;
      ...
      */
        ...
        <seealso cref="Container"/>
      */
        public abstract PdfObject Parent { get; internal set; }
      ...
      */
        public abstract bool Updateable { get; set; }

        /**
        <summary>Gets/Sets whether the initial state of this object has been modified.</summary>
      */
        public abstract bool Updated { get; protected internal set; }
      ...
      */
        protected internal abstract bool Virtual { get; set; }
        #endregion
      ...
      */
        ...
        )
        {
            if (obj != null)
            {
                if (obj.Parent != null) obj = (PdfDataObject) obj.Clone();
                obj.Parent = this;
            }
