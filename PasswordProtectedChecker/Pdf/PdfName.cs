                ...
                */
                var buffer = new StringBuilder();
                {
                    ...
                    while (unescapedMatch.Success)
                    {
                        ...
                        if (start > index) buffer.Append(stringValue.Substring(index, start - index));
                    ...
                    if (index < stringValue.Length) buffer.Append(stringValue.Substring(index));
                }
        ...
        )
        {
            ...
            */
            ...
            while (escapedMatch.Success)
            {
                ...
                if (start > index) buffer.Append(value.Substring(index, start - index));
            ...
            if (index < value.Length) buffer.Append(value.Substring(index));
...
#pragma warning disable 0108
      ...
      */
        public new static PdfName Get(object value)
        {
