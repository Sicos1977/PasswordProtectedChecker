    ...
    public sealed class ObjectStream : PdfStream, IDictionary<int, PdfDataObject>
    {
        ...
        private sealed class ObjectEntry
        {
            ...
            ) : this(parser)
            {
                ...
                offset = -1; // Undefined -- to set on stream serialization.
            }
        }
        #endregion
      ...
      */
        ...
        #region constructors
        public ObjectStream(
        ) : base(new PdfDictionary(new[] {PdfName.Type}, new PdfDirectObject[] {PdfName.ObjStm}))
        {
        }
      ...
      */
        ...
        public ICollection<PdfDataObject> Values
        {
            get
            {
                ...
                foreach (var key in Entries.Keys) values.Add(this[key]);
                return values;
            }
        }
        ...
        {
            foreach (var key in Keys) yield return new KeyValuePair<int, PdfDataObject>(key, this[key]);
        }
            ...
            get
            {
                if (entries == null)
                {
                    ...
                    if (body.Length > 0)
                    {
                        ...
                        var baseOffset = ((PdfInteger) Header[PdfName.First]).IntValue;
                        for (
                            int index = 0,
                        ...
                        {
                            var objectNumber = ((PdfInteger) parser.ParsePdfObject(1)).IntValue;
                            var objectOffset = baseOffset + ((PdfInteger) parser.ParsePdfObject(1)).IntValue;
                ...
                foreach (var entry in Entries)
                {
                    ...
                    */
                    ...
                    indexBuffer
                        ...
                        .Append(entryValueOffset.ToString())
                        .Append(Chunk.Space); // Byte offset (relative to the first one).
